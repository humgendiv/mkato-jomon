...
bcftools mpileup -q 5 -Q 5 -Ou -r $CHROM -f $REFERENCE $BAMFILE | bcftools call -c -V indels | $MSMC_TOOLS/bamCaller.py $DEPTH $OUTDIR/${SAMPLENAME}_${CHROM_WITHOUT_CHR}_mask.bed.gz | gzip -c > $OUTDIR/${SAMPLENAME}_${CHROM_WITHOUT_CHR}.vcf.gz
